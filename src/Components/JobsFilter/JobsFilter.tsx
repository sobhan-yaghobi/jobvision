        ...
        if (props.mode === "ShowFilter") {
            ...
            return (
                ...
                >
                    ...
                    <div className="absolute w-[10.5rem] top-full z-10 invisible opacity-0 right-5 group-hover:visible group-hover:opacity-100 group-hover:right-0">
                        <ul className="mt-2 shadow-xl rounded-xl border-solid border-[1px] border-jv-lightGray3x bg-jv-light overflow-hidden">
                            <li
                                onClick={() => {
                                    setSelectedFilters([]);
                                }}
                                className="py-2 px-3 flex items-center justify-between text-jv-danger hover:bg-jv-lightDanger"
                            >
                                <span>حذف همه</span>
                                <GoTrash />
                            </li>
                            <li
                                ...
                                className="py-2 px-3 flex items-center justify-between hover:bg-jv-lightPrimary hover:text-jv-primary"
                            >
