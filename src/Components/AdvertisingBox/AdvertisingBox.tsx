...
const AdvertisingBox: React.FC<AdvertisingBoxProps> = (props) => {
    ...
    const jobTypes = jobData.ads_types;
    const AdvertisingPublisTime: TimeType = getTime(jobData.created_at);
    const className = {
            ...
            <>
                ...
                >
                    ...
                    <span className="mt-2 text-xs flex justify-center gap-1 items-center">
                        ...
                        <span id="Score">{jobCompany.score_company}</span>
                    </span>
                </div>
                <div id="Content" className="text-sm px-1 col-span-9 sm:col-span-10 overflow-hidden">
                    ...
                    <div className={`text-jv-lightGray2x truncate flex`}>
                        ...
                        <span id="SalaryOffer">
                            {jobData.rights_price.at(0)} - {jobData.rights_price.at(1)}
    ...
    if (props.type === "ShowSendCv") {
        ...
        const jobStatus = [jobData.status_is_important, jobData.status_cv_pending, jobData.status_responsible_employer];
        return (
            <>
